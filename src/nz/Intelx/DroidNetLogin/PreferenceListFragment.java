...
//This defines the fragment of the Options page
...
public class PreferenceListFragment extends SherlockListFragment{
    ...
    static PreferenceListFragment newInstance(int xmlID){
    	PreferenceListFragment p = new PreferenceListFragment(xmlID);
    	return p;
    }
